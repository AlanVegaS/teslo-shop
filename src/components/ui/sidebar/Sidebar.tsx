...
import { IoCloseOutline, IoLogInOutline, IoLogOutOutline, IoPeopleOutline, IoSearchOutline, IoShirtOutline, IoTicketOutline } from 'react-icons/io5';
        ...
        <div >
            ...
            >
                ...
                <div className="relative mt-14">
                    <IoSearchOutline size={18} className="absolute top-2.5 left-2  text-gray-600" />
                    <input
                        type='text'
                        placeholder="Find"
